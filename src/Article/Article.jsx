...
const Article = () => {
  return (
    <React.Fragment>
    <html lang="en"></html>
    <h1>The Statue of Liberty's torch heads to new museum
    </h1>
    <p><i>by Kate Farle ( <span style={{color: '#0000ff'}}>kate.farley@nytimes.com </span>)</i><br/> November 22, 2018</p>
    ...
    <p>&ldquo; Although it is not one of the most difficult things we have ever moved, &rdquo; says Douglas Phelps, who oversaw the relocation of the torch, &ldquo;it is certainly the most important.&rdquo;</p>
    ...
    <p>&ldquo; The original torch is a beautiful object of art and exemplifies the American ideals of freedom and democracy, &rdquo; says John Piltzecker, superintendent of the Statue of Liberty National Monument. That symbolic spirit inspired the decision to inscribe these famous lines on the statue's pedestal:</p>
    ...
    <ul>
    <li>Total overall height from the base of the pedestal foundation to the tip of the torch is <strong>305 feet, </strong>6 <strong>inches</strong></li>
    <li>Height of the Statue from her heel to the top of her head is 111 feet, 6 inches</li>
    <li>The Statue has a <strong>35&bull;foot</strong> waistline</li>
    <li>Total weight of the Statue of Liberty is <strong>225</strong> <strong>tons</strong> <strong>(or</strong> <strong>450,000</strong> <strong>pounds)</strong></li>
    </ul>
    <p>&nbsp;</p>
    </React.Fragment>
  )
